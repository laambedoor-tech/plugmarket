...
const products = [
  ...
  { id: 'chatgpt-plus', title: 'ChatGPT Plus', price: 'From €2.88', tone: 'teal' },
  { id: 'chatgpt-pro', title: 'ChatGPT Pro', price: 'From €0.99', tone: 'teal' },
  { id: 'gemini', title: 'Gemini Pro FA', price: 'From €1.75', tone: 'blue' },
...
const subscriptions = {
  ...
  'chatgpt-plus': { '1 Month': 2.88, '3 Months': 7.02, '6 Months': 10.69, '12 Months': 8.5 },
  ...
  document.querySelectorAll('.product-card').forEach(card => {
    card.addEventListener('click', (e) => {
      ...
      const pageMap = {
        ...
        'chatgpt-plus': 'product-chatgpt.html',
        'chatgpt-pro': 'product-chatgpt-pro.html',
        'gemini': 'product-gemini.html',
    ...
    if (pid === 'nitro') {
      modalContent.innerHTML = `
        <div class="card" style="margin:10px; padding:20px; text-align:center;">
          ...
          <a href="https://discord.gg/yx63NfvYmT" target="_blank" class="btn btn--primary" style="display:inline-block; text-decoration:none;">Join Discord Server</a>
        </div>
      `;
